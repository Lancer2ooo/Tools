...
import com.example.tools.widget.TranslateResult;
...
public class TranslateActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String appId = "20210930000960941";//APP ID 来源于百度翻译平台 请使用自己的
    private String key = "5WYK149N7K06B_9b2PLi";//秘钥 来源于百度翻译平台 请使用自己的
